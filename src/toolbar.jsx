...
Registry.register(" DraggableTabs", DraggableTabs);
Registry.register("PanelComponent", DraggablePanel);
  ...
  _defaultItems(intl) {
    return [
      ...
      },
      {
        ...
        type: "custom",
        field_name: "panel_component",
        name: "Panel",
        icon: "fa fa-cog",
        static: true,
        props: { test: "panel_comp" },
        label: "Label panel",
      },
    ];
  }
